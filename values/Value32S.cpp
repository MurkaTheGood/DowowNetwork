...
char* DowowNetwork::Value32S::SerializeInternal() {
...
uint32_t DowowNetwork::Value32S::GetSizeInternal() {
    return sizeof(value);
}

std::string DowowNetwork::Value32S::ToStringInternal(uint16_t indent) {
