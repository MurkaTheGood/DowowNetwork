...
const char* DowowNetwork::Value32U::SerializeInternal() const {
...
uint32_t DowowNetwork::Value32U::GetSizeInternal() const {
    return sizeof(value);
}

std::string DowowNetwork::Value32U::ToStringInternal(uint16_t indent) const {
